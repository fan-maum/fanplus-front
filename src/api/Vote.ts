import { FirstRankStarData, VoteResponse } from './../types/vote';
import { VoteDataTemp } from '@/types/vote';

export const getVotes = async (): Promise<VoteResponse> => {
        ...
        DATA: [
          {
            ...
            START_DATE: new Date('2023-06-29 17:00:00'),
            END_DATE: new Date('2023-07-12 17:00:00'), //투표종료일자
          ...
          },
          {
            ...
            START_DATE: new Date('2023-06-29 17:00:00'),
            END_DATE: new Date('2023-07-12 17:00:00'),
            STATUS: 'N',
            FIRST_RANK_STAR_INFO: {
              STAR_IDX: '34',
              STAR_GROUP_IDX: '2',

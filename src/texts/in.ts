...
export const VoteModal_Text_in: any = ({ n, starName, N }: voteModalTextProps) => {
  const modalItems = {
    ...
    voteBlockEnd: `FanPlus app Instal aplikasinya.<br/>Anda mendapatkan <b>${N}</b> suara memberikan suara setiap hari`,
  };
  return modalItems;
};

...
export const CommunityPostText_IND: CommunityPostTextType = {
  ...
  alreadyDeleted: "Komentar telah dihapus.",
  ...
  reportWarning: ["Konten yang dilaporkan akan diproses sesuai dengan kebijakan pengoperasian dan persyaratan penggunaan. Jika ini adalah laporan palsu,","penggunaan layanan FanPlus oleh pelapor dapat dibatasi."],
};

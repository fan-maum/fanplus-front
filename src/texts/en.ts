...
export const CommunityPostText_ENG: CommunityPostTextType = {
  ...
  alreadyDeleted: "This comment has been deleted",
  ...
  reportWarning: ["Reported content will be processed according to the operating policy and terms of use.","If it is a false report, the reporter's use of FanPlus service may be restricted."],
};

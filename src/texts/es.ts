...
export const CommunityPostText_ESP: CommunityPostTextType = {
  ...
  reportWarning: ["Se procederá el contenido denunciado según las políticas de operación y términos de uso. Si es una denuncia falsa,","se podría restringir el uso del servicio de FanPlus por parte del denunciante."],
};

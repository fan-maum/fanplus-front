...
export const voteModalTexts: LangStringType<VoteModalFuncType> = {
  ko: ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
  ...
  en: ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
  ...
  es: ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
  ...
  in: ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
  ...
  ja: ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
  ...
  vi: ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
  ...
  'zh-CN': ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
  ...
  'zh-TW': ({ freeVoteCount, starName, moreVoteCount }) => {
    return {
